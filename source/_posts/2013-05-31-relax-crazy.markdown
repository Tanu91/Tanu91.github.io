...
* Creating Github User/Organization Pages
  ...
  * Switch over to new repository created in previous step. Click on Settings Tab , scroll down to Github pages and click on "Automatic Page generator" button. {% img https://github-images.s3.amazonaws.com/help/repo-actions-settings.png 250 250 %}{% img right https://github-images.s3.amazonaws.com/blog/2012/page-generator-picker.png 250 250 %}
